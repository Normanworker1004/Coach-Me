...
import 'package:cme/player_pages/buddy_up/buddy_confirmation_page.dart';
...
class BuddyUpBookingPage extends StatefulWidget {
  final UserModel? userModel;
  final Userdetails userdetails;
  final String sport;

  const BuddyUpBookingPage({
    Key? key,
  ...
  @override
  _BuddyUpBookingPageState createState() => _BuddyUpBookingPageState();
}

class _BuddyUpBookingPageState extends State<BuddyUpBookingPage> {
  ...
  Future gotoNext(BuildContext context) async {
    ...
    try {
      CreateBuddyBookingResponse b = await createBuddyUpBooking(
