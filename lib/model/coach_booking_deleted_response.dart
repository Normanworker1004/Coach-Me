class CoachBookingDeletedResponse {
  bool? status;
  String? message;
  Details? details;

  CoachBookingDeletedResponse({this.status, this.message, this.details});

  CoachBookingDeletedResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
