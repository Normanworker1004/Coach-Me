              ...
              child: Row(
                ...
                children: [
                  buildToolTipWithText(
                      text:
                          "Slide across to amend card details include delete, default card and edit."),
        ...
        if (snapshot == null) {
          ...
          if (snapshot.data == null) {
            ...
            List<Giftcard>? giftCards =
                f.message == null ? [] : f.message!.giftcard;
            return cards.isEmpty && giftCards!.isEmpty
                ? Center(
                    child: Column(
          ...
          children: <Widget>[
            Row(
              children: [
                ...
                Visibility(
                  // TODO: This is the default card sign. Write an algorithm to make it invisible for none default cards
                  visible: defaultCard,
                  child: Padding(
