...
class EarningsMonthlyChart extends StatelessWidget {
  ...
  EarningsMonthlyChart(this.seriesList,
      {this.animate, this.month, this.target});

  @override
  Widget build(BuildContext context) {
    final starts = (month != null ? month! : currentMonth);
    return new charts.TimeSeriesChart(
      seriesList.cast<charts.Series<dynamic, DateTime>>(),
