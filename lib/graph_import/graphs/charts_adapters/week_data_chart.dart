...
class WeekDataChart extends StatelessWidget {
  final List<charts.Series<WeeklyStatsDataModel, int>> seriesList;
  final bool? animate;
  ...
  WeekDataChart(this.seriesList, {this.animate, this.target});
